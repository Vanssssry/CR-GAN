...
def create_loader(opt,kwargs):
    ...
    dataset1 = datasets.CIFAR10('data-CIFAR10', train=True, download=True,transform=data_transform)
    data1 = dataset1.data
    ...
    dataset3 = datasets.CIFAR10('data-CIFAR10', train=True, download=True,transform=data_transform)
    ...
    dataset2 = datasets.CIFAR10('data-CIFAR10', train=True, download=True,transform=data_transform)
    data2 = dataset2.data
    ...
    # print(dataset2.data.shape, auxiliary_num)
    ...
    dataset_val = datasets.CIFAR10('data-CIFAR10', train=False, download=True,transform=data_transform)
    ...
    dataset_test = datasets.CIFAR10('data-CIFAR10', train=False, download=True,transform=data_transform)
