...
def create_loader(opt,kwargs):
    ...
    dataset1 = datasets.FashionMNIST('data-FashionMNIST', train=True, download=True,transform=data_transform)
    data1 = dataset1.data
    ...
    dataset3 = datasets.FashionMNIST('data-FashionMNIST', train=True, download=True,transform=data_transform)
    ...
    dataset2 = datasets.FashionMNIST('data-FashionMNIST', train=True, download=True,transform=data_transform)
    data2 = dataset2.data
    ...
    dataset_val = datasets.FashionMNIST('data-FashionMNIST', train=False, download=True,transform=data_transform)
    ...
    dataset_test = datasets.FashionMNIST('data-FashionMNIST', train=False, download=True,transform=data_transform)
